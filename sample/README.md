...
====================
Sample project using React Plume SSR.

Once built, the SSR server can be run using `node build/server/index.js --configFile conf-ssr.json --httpPort 3131`.

The Java server https://github.com/Coreoz/Plume-showcase should be used to have some data for the API call.
